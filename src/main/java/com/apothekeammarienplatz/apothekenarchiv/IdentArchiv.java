...
public class IdentArchiv extends javax.swing.JPanel {
	...
	private String vorschlagenChargenNummer() {
		...
		/**
		 * TODO: Statt der "1" könnte man direkt den nächsten noch nicht verwendeten int
		 * verwenden. Dazu müsste das Programm eine Datenbank zu den bereits
		 * durchgeführten Prüfungen führen.
		 */
	...
	private void initComponents() {
		...
		jTextField1.setName("identStoffnameInput");
		...
		dateiPanelLayout.setHorizontalGroup(dateiPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(dateiPanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(dateiPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
								.addComponent(unterschriftPrüfenButton, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(dateiAnzeigenButton, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(dateiLöschenButton, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		dateiPanelLayout
				.setVerticalGroup(dateiPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(dateiPanelLayout.createSequentialGroup()
								...
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(dateiLöschenButton).addContainerGap()));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								layout.createSequentialGroup().addComponent(zurückButton).addGap(0, 0, Short.MAX_VALUE))
						.addComponent(dateiPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
				.addContainerGap()));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addContainerGap()
						...
						.addGap(18, 18, 18)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(startButton).addComponent(zurückButton))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(dateiPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
	...
	private void startButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_startButtonActionPerformed
		try {
			...
			PreparedStatement preparedStatement = databaseWrapper.prepareStatement(
					"INSERT INTO `identitätsarchiv` SET `stoffName` = ?, `chargenNummer` = ?, `dateiName` = ?, `dateiNameUnterschrift` = ?");
			...
			/**
			 * Die Datei existiert bereits. Wir erstellen eine Frage an den Benutzer. Wenn
			 * der Benutzer es wünscht, können die alten Dateien überschrieben werden und
			...
			int überschreibenAntwort = JOptionPane.showConfirmDialog(null,
					"Die Datei existiert bereits. Soll sie überschrieben werden?", "Datei überschreiben",
			...
			if (0 == überschreibenAntwort) {
				/**
				 * Die alte Datei wird überschrieben. Danach kann die neue Datei erstellt
				 * werden. Wir löschen sowohl die PDF-datei, als auch die eventuell existierende
				 * Signatur und die verschlüsselte Datei.
				 */
				// JOptionPane.showConfirmDialog(null, existingFileName, "Delete!",
				// JOptionPane.DEFAULT_OPTION);
				boolean deleteSuccess = ScannerWrapper.deleteFile(existingFileName);
				System.out.println(deleteSuccess);
				/**
				 * Achtung Rekursion! Jetzt, nach dem Löschen können wir die gleiche Funktion
	...
	private void unterschriftPrüfenButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_unterschriftPrüfenButtonActionPerformed
		try {
			Desktop.getDesktop().open(
					new File(archivedFileWithPath.getAbsolutePath() + CryptoWrapper.FILENAME_EXTENSION_SIGNATURE));
	...
	private void dateiLöschenButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_dateiLöschenButtonActionPerformed
		int löschenAntwort = JOptionPane.showConfirmDialog(null, "Soll die Datei gelöscht werden?", "Datei entfernen",
				JOptionPane.YES_NO_OPTION);
